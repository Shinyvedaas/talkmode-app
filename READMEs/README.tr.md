...
[Latest release](https://talkmode.baryon.ai/download/TalkMode-0.4.9.zip) → zip'i açın → `Applications` klasörüne sürükleyin → ilk açılışta macOS "from unknown developer" diyebilir, bir kez sağ tıklayın → Open.
