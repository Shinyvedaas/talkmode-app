...
[Rilis terbaru](https://talkmode.baryon.ai/download/TalkMode-0.4.9.zip) → ekstrak → seret ke `Applications` → pada peluncuran pertama macOS mungkin berkata "dari pengembang tak dikenal", klik kanan → Open sekali.
