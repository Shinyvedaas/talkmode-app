...
[أحدث إصدار](https://talkmode.baryon.ai/download/TalkMode-0.4.6.zip) ← فُكّ الضغط ← اسحبه إلى `Applications` ← عند الإطلاق الأول قد يقول macOS «من مطوّر غير معروف»، انقر بالزر الأيمن ← فتح مرّة واحدة.
