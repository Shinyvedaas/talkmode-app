...
[Latest release](https://talkmode.baryon.ai/download/TalkMode-0.4.5.zip) → uitpakken → naar `Applications` slepen → bij de eerste keer openen kan macOS "from unknown developer" zeggen, klik eenmaal met de rechtermuisknop → Open.
