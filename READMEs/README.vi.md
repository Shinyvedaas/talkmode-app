...
[Bản phát hành mới nhất](https://talkmode.baryon.ai/download/TalkMode-0.4.6.zip) → giải nén → kéo vào `Applications` → ở lần khởi chạy đầu tiên macOS có thể nói "từ nhà phát triển không xác định", nhấp chuột phải → Open một lần.
