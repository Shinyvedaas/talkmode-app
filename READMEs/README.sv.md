...
[Latest release](https://talkmode.baryon.ai/download/TalkMode-0.4.9.zip) → packa upp → dra till `Applications` → vid första öppningen kan macOS säga "from unknown developer", högerklicka → Open en gång.
