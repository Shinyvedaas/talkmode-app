...
[नवीनतम रिलीज़](https://talkmode.baryon.ai/download/TalkMode-0.4.6.zip) → अनज़िप करें → `Applications` में खींचें → पहले लॉन्च पर macOS कह सकता है "अज्ञात डेवलपर से", राइट-क्लिक करें → एक बार Open करें।
