...
[Ultima versione](https://talkmode.baryon.ai/download/TalkMode-0.4.2.zip) → estrai → trascina in `Applications` → al primo avvio macOS potrebbe dire "da uno sviluppatore non identificato", fai clic destro → Apri una volta.
