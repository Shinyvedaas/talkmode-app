...
[Dernière version](https://talkmode.baryon.ai/download/TalkMode-0.4.5.zip) → décompresser → glisser dans `Applications` → au premier lancement, macOS peut indiquer « d'un développeur non identifié », faites un clic droit → Ouvrir une fois.
