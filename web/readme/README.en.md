...
[Latest release](https://talkmode.baryon.ai/download/TalkMode-0.4.5.zip) → unzip → drag into `Applications` → first launch macOS may say "from unknown developer", right-click → Open once.
