...
[Neueste Version](https://talkmode.baryon.ai/download/TalkMode-0.4.6.zip) → entpacken → in `Applications` ziehen → beim ersten Start sagt macOS möglicherweise „von einem nicht identifizierten Entwickler", Rechtsklick → einmal Öffnen.
