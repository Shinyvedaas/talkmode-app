...
[Última versión](https://talkmode.baryon.ai/download/TalkMode-0.4.5.zip) → descomprimir → arrastrar a `Applications` → en el primer lanzamiento macOS puede decir "de un desarrollador no identificado", haz clic derecho → Abrir una vez.
