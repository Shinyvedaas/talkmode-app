...
[Latest release](https://talkmode.baryon.ai/download/TalkMode-0.4.5.zip) → rozpakuj → przeciągnij do `Applications` → przy pierwszym uruchomieniu macOS może powiedzieć „from unknown developer", kliknij prawym przyciskiem → Open jeden raz.
